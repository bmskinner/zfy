...
find.common.aa.9aaTADs <- function(locations.9aaTAD, rc.threshold = 80, coverage.threshold = 21){
  ...
  tads.filtered <- locations.9aaTAD[locations.9aaTAD$rc_score>=rc.threshold & locations.9aaTAD$end_gapped < mouse.exons$start_aa_combined[7],]
...
find.common.nt.9aaTADs <- function(locations.9aaTAD, rc.threshold = 80, coverage.threshold = 21){
  ...
  # We only want to use the high confidence 9aaTADs, and ignore the site in exon 7
  tads.filtered <- locations.9aaTAD[locations.9aaTAD$rc_score>=rc.threshold & locations.9aaTAD$end_nt_gapped < mouse.exons$start_nt_combined[7],]
